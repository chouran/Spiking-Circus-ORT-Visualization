...
class Canvas(app.Canvas):
    ...
    def __init__(self):
        app.Canvas.__init__(self, title='Use your wheel to zoom!', show=True,
                            keys='interactive')
        ...
        self.program_bis['a_box_index'] = box_index
        #self.program_bis['a_box_position'] = box_pos
        self.program_bis['a_corner_position'] = corner_positions
        self.program_bis['u_size'] = (nrows, ncols)
        self.program_bis['u_scale'] = (1., 1.)
        #self.program_bis['u_x_min'] = time_range[0]
        #self.program_bis['u_x_max'] = time_range[1]
        #self.program_bis['u_y_min'] = amp_range[0]
        #self.program_bis['u_y_max'] = amp_range[1]
        #self.program_bis['u_d_scale'] = 1
